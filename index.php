...
<html>
	...
	<body>
		<div id="content">
			<h1>Microboard - Site Title </h1>
			<div class="nav">[ / <a href="board">board</a> / ]</div>
			<hr>
			<b>microboard</b> is a simple message board solution developed to be stream-lined and simple to use.
